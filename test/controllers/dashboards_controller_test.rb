...
class DashboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dashboard" do
    assert_difference('Dashboard.count') do
      post dashboards_url, params: { dashboard: { description: @dashboard.description, position: @dashboard.position, title: @dashboard.title, user_id: @dashboard.user_id } }
    end
  ...
  test "should update dashboard" do
    patch dashboard_url(@dashboard), params: { dashboard: { description: @dashboard.description, position: @dashboard.position, title: @dashboard.title, user_id: @dashboard.user_id } }
